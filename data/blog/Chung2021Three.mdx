...
lastmod: '2021-02-01'
tags: ['Accessibilty', 'Survey', 'guide']
draft: false
summary: 'An overview of the new features released in v1 - code block copy, multiple authors, frontmatter layout and more'
layout: PostSimple
bibliography: references-data.bib
canonicalUrl: https://www.jmir.org/2023/1/e43917
co_authors: 'SeungA Chung, Kyungyeon Lee, Sohyeon Park, Uran Oh'
vennue: 'In 2021 IEEE International Conference on Pervasive Computing and Communications Workshops and other Affiliated Events (PerCom Workshops) (pp. 81-86). IEEE.'
pdf: 'papers/Chung2021Three.pdf'
---
