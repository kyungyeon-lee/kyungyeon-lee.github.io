...
date: 2021-11-07T15:32:14Z
tags: ['next js', 'math', 'ols']
draft: false
co_authors: 'Kyungyeon Lee*, Sohyeon Park*, Uran Oh'
vennue: 'In Extended Abstracts of the 2021 CHI Conference on Human Factors in Computing Systems (pp. 1-6).'
summary: 'How to derive the OLS Estimator with matrix notation and a tour of math typesetting using markdown with the help of KaTeX.'
pdf: 'papers/Lee2021Designing.pdf'
video: 'https://www.youtube.com/watch?v=RrRl6UFC6ZM'
---
