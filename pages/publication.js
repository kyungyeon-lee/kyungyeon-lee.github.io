                  ...
                  <div className="space-y-5 xl:col-span-3">
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex flex-wrap py-1">
                          <Link href={pdf}>
                            <button class="inline-flex items-center rounded border border-red-500 bg-transparent px-2 py-1 font-semibold text-red-700 hover:border-transparent hover:bg-red-500 hover:text-white">
                              <svg
                              ...
                              <span class="m-1">PDF</span>
                            </button>
                          </Link>{' '}
                          {video ? (
                          <Link href={video}>
                          <button class="mx-2 inline-flex items-center rounded border border-blue-500 bg-transparent px-2 py-1 font-semibold text-blue-700 hover:border-transparent hover:bg-blue-500 hover:text-white">
